...
def make_figure(equity_df, currency_df, bond_df) -> go.Figure:
    ...
    fig = make_subplots(rows=3, cols=1, shared_xaxes=True, shared_yaxes=False, vertical_spacing=0)  # noqa
    ...
    fig.update_xaxes(showgrid=False, zeroline=False, showline=False, gridcolor="white", showticklabels=False, linecolor="white")    # noqa
    fig.update_yaxes(showgrid=False, zeroline=False, showline=False, gridcolor="white", showticklabels=False, linecolor="white")    # noqa
